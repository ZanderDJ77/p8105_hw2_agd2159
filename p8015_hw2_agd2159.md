...
It appears that **4 participants had MCI at baseline** and need to be
excluded from the stats analysis to avoid bias.

**Task 2**

Beginning to Clean Amyloid Biomarker Time Series Dataframe:

``` r
amyloid_new = mci_amyloid |> 
  pivot_longer(
    baseline:time_8,
